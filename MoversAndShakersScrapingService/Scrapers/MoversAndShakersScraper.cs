...
{
    public class ScrapeMoversShakers : SeleniumDriver
    {
        public MoverCardDataModel GetListMoversShakesTable(MoversShakersTableEnum movertype, MTGFormatsEnum format, string elementXPath)
        {
            try
            {
                ...
                _driver.Navigate().GoToUrl($"https://www.mtggoldfish.com/movers/paper/{format.ToString()}");
                var DailyChangeIncrease = _driver.FindElements(By.XPath(elementXPath));
        ...
        private string[] GetDailyIncreaseNames()
        {
            ...
            {
                var DailyName = _driver.FindElement(By.XPath($"/html/body/main/div[6]/div[1]/div/div/div[1]/table/tbody/tr[{i + 1}]/td[4]/a"));
        ...
        private string[] GetDailyDecreaseNames()
        {
            ...
            for (int i = 0; i < NameArry.Length; i++)
            {
                var Name = _driver.FindElement(By.XPath($"/html/body/main/div[6]/div[1]/div/div/div[1]/table/tbody/tr[{i + 1}]/td[4]/a"));
